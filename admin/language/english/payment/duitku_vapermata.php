<?php
// Heading
$_['heading_title']      = 'Duitku Vapermata';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_vapermata']= '<img src="view/image/payment/vapermata.png" width="60" height = "25" alt="Duitku Vapermata" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_duitku_vapermata_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_duitku_vapermata_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
