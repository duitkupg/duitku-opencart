<?php
// Heading
$_['heading_title']      = 'Duitku ShopeepayApp';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_shopeepayapp'] = '<img src="view/image/payment/shopeepay.png" width="60" height = "25" alt="Duitku ShopeepayApp" title="Duitku" style="border: 1px solid #EEEEEE;" />';
