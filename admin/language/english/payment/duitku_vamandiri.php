<?php
// Heading
$_['heading_title']      = 'Duitku Vamandiri';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_vamandiri']= '<img src="view/image/payment/vamandiri.png" width="60" height = "25" alt="Duitku Vamandiri" title="Duitku" style="border: 1px solid #EEEEEE;" />';
