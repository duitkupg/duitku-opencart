...
$_['text_duitku_briva'] = '<img src="view/image/payment/briva.png" width="60" height = "25" alt="Duitku BRIVA" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_duitku_briva_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_duitku_briva_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_duitku_briva_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
