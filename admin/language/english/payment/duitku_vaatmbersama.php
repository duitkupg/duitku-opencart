<?php
// Heading
$_['heading_title']      = 'Duitku Vaatmbersama';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_vaatmbersama']= '<img src="view/image/payment/vaatmbersama.png" width="60" height = "25" alt="Duitku Vaatmbersama" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_duitku_vaatmbersama_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_duitku_vaatmbersama_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
