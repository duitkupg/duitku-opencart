...
$_['text_duitku_pospay'] = '<img src="view/image/payment/pospay.png" width="60" height = "25" alt="Duitku PosPay" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_duitku_pospay_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_duitku_pospay_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_duitku_pospay_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
