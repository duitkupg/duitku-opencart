<?php
// Heading
$_['heading_title']      = 'Duitku DANA';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_dana'] = '<img src="view/image/payment/dana.png" width="60" height = "25" alt="Duitku DANA" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_duitku_dana_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_duitku_dana_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_duitku_dana_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
