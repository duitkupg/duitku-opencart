<?php
// Heading
$_['heading_title']      = 'Duitku Indomaret';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_indomaret'] = '<img src="view/image/payment/indomaret.png" width="60" height = "25" alt="Duitku Ritel" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_indomaret_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_indomaret_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_indomaret_failure_mapping'] = 'Map Payment Failure Status to Order Status';
