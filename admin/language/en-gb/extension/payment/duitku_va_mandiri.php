...
$_['text_duitku_va_mandiri'] = '<img src="view/image/payment/duitkumandiri.png" width="60" height = "25" alt="Duitku VA MANDIRI" title="Duitku" style="border: 1px solid #EEEEEE;" />';
$_['text_live']          = 'Production';
$_['text_successful']    = 'Always Successful';
$_['text_fail']          = 'Always Fail';
$_['text_edit']          = 'Configure Duitku VA Mandiri (Deprecated)';
...
$_['entry_payment_duitku_va_mandiri_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_va_mandiri_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_va_mandiri_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
