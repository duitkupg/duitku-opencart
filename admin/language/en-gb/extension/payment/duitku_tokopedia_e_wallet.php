<?php
// Heading
$_['heading_title']      = 'Duitku TOKOPEDIA E-WALLET';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_tokopedia_e_wallet'] = '<img src="view/image/payment/tokopedia_e_wallet.png" width="60" height = "25" alt="Duitku TOKOPEDIA E-WALLET" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_tokopedia_e_wallet_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_tokopedia_e_wallet_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_tokopedia_e_wallet_failure_mapping'] = 'Map Payment Failure Status to Order Status';
