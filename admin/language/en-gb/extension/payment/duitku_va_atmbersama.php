<?php
// Heading
$_['heading_title']      = 'Duitku VA Atm Bersama';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_va_atmbersama'] = '<img src="view/image/payment/duitkuatmbersama.png" width="60" height = "25" alt="Duitku VA Atm Bersama" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_va_atmbersama_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_va_atmbersama_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_va_atmbersama_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
