<?php
// Heading
$_['heading_title']      = 'Duitku LinkAja QRIS';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_qris'] = '<img src="view/image/payment/linkaja.png" width="60" height = "25" alt="Duitku LinkAja QRIS" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_qris_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_qris_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_qris_failure_mapping'] = 'Map Payment Failure Status to Order Status';
