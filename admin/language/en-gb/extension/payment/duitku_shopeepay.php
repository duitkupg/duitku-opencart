<?php
// Heading
$_['heading_title']      = 'Duitku SHOPEEPAY';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_shopeepay'] = '<img src="view/image/payment/shopeepay.png" width="60" height = "25" alt="Duitku SHOPEEPAY" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_shopeepay_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_shopeepay_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_shopeepay_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
