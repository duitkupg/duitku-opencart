<?php
// Heading
$_['heading_title']      = 'Duitku TOKOPEDIA OTHERS';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_tokopedia_others'] = '<img src="view/image/payment/tokopedia_others.png" width="60" height = "25" alt="Duitku TOKOPEDIA OTHERS" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_tokopedia_others_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_tokopedia_others_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_tokopedia_others_failure_mapping'] = 'Map Payment Failure Status to Order Status';
