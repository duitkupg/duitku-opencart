<?php
// Heading
$_['heading_title']      = 'Duitku VA Permata';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_va_permata'] = '<img src="view/image/payment/duitkuperm.png" width="60" height = "25" alt="Duitku VA Permata" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_va_permata_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_va_permata_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_va_permata_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
