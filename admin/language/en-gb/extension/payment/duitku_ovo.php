<?php
// Heading
$_['heading_title']      = 'Duitku OVO';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_ovo'] = '<img src="view/image/payment/ovo.png" width="60" height = "25" alt="Duitku OVO" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_ovo_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_ovo_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_ovo_failure_mapping'] = 'Map Payment Failure Status to Order Status';
