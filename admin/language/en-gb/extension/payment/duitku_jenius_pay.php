<?php
// Heading
$_['heading_title']      = 'Duitku Jenius Pay';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_jenius_pay'] = '<img src="view/image/payment/jenius-pay.png" width="60" height = "25" alt="Duitku jenius pay" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_jenius_pay_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_jenius_pay_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_jenius_pay_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
