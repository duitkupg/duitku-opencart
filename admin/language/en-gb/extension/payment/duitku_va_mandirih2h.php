<?php
// Heading
$_['heading_title']      = 'Duitku VA Mandiri Direct';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_va_mandirih2h'] = '<img src="view/image/payment/duitkumandiri.png" width="60" height = "25" alt="Duitku VA Mandiri Direct " title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_va_mandirih2h_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_va_mandirih2h_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_va_mandirih2h_failure_mapping'] = 'Map Payment Failure Status to Order Status';
