<?php
// Heading
$_['heading_title']      = 'Duitku VA Sahabat Sampoerna';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_va_sampoerna'] = '<img src="view/image/payment/sampoerna.png" width="60" height = "25" alt="Duitku VA Sahabat Sampoerna" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_va_sampoerna_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_va_sampoerna_pending_mapping'] = 'Map Payment Pending Status to Order Status:';
$_['entry_payment_duitku_va_sampoerna_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
