<?php
// Heading
$_['heading_title']      = 'Duitku TOKOPEDIA CARD PAYMENT';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_tokopedia_card_payment'] = '<img src="view/image/payment/tokopedia_card_payment.png" width="60" height = "25" alt="Duitku TOKOPEDIA CARD PAYMENT" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_tokopedia_card_payment_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_tokopedia_card_payment_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_tokopedia_card_payment_failure_mapping'] = 'Map Payment Failure Status to Order Status';
