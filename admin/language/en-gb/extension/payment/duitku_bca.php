<?php
// Heading
$_['heading_title']      = 'Duitku BCA';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_bca'] = '<img src="view/image/payment/bca-klikpay.png" width="60" height = "25" alt="Duitku BCA" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_bca_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_bca_failure_mapping'] = 'Map Payment Failure Status to Order Status';
