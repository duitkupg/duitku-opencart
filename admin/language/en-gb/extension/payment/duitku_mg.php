...
$_['text_duitku_mg'] = '<img src="view/image/payment/migs.png" width="60" height = "25" alt="Duitku Credit Card" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_api_credcode']      = 'Merchant Credential Code';
...
$_['entry_payment_duitku_mg_success_mapping'] = 'Map Payment Success Status to Order Status:';
$_['entry_payment_duitku_mg_failure_mapping'] = 'Map Payment Failure Status to Order Status:';
