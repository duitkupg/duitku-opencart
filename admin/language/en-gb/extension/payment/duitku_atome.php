<?php
// Heading
$_['heading_title']      = 'Duitku ATOME';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Duitku account details!';
$_['text_duitku_atome'] = '<img src="view/image/payment/atome.png" width="60" height = "25" alt="Duitku ATOME" title="Duitku" style="border: 1px solid #EEEEEE;" />';
...
$_['entry_payment_duitku_atome_success_mapping'] = 'Map Payment Success Status to Order Status';
$_['entry_payment_duitku_atome_pending_mapping'] = 'Map Payment Pending Status to Order Status';
$_['entry_payment_duitku_atome_failure_mapping'] = 'Map Payment Failure Status to Order Status';
...
$_['error_merchant']     = 'Merchant Code is required!';
...
$_['error_expired_period']   = 'Expired Period is required! 1 - 720 ( minute )';
?>