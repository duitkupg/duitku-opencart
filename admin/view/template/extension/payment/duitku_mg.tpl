		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
						...
						<div class="form-group required v2_settings sensitive">
							<label class="col-sm-2 control-label" for="input-merchant-id"><?php echo $entry_credcode; ?></label>
							<div class="col-sm-3">
							  <input type="text" name="duitku_mg_crecode" value="<?php echo $duitku_mg_credcode; ?>" id="input-merchant-id" class="form-control" />
							</div>
						</div>
						<!-- Client Key (v2-specific) -->
