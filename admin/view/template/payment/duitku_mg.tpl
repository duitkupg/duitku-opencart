		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_mg_display_name" value="<?php echo $duitku_mg_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_mg_endpoint" value="<?php echo $duitku_mg_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_mg_merchant" value="<?php echo $duitku_mg_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_mg_api_key" value="<?php echo $duitku_mg_api_key; ?>" />
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $entry_credcode; ?></td>
            <td><input type="text" name="duitku_mg_credcode" value="<?php echo $duitku_mg_credcode; ?>" />
            </td>
          </tr>
          <!-- API Key -->
          ...
          <tr>
            ...
            <td>
              <select name="duitku_mg_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_mg_sort_order" value="<?php echo $duitku_mg_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
