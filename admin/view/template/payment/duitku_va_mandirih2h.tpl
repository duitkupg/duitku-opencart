			...
			<div class="panel-body">
				  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
							  <select name="duitku_va_mandirih2h_status" id="input-mode" class="form-control">
								<?php $options = array('1' => $text_enabled, '0' => $text_disabled) ?>
								<?php foreach ($options as $key => $value): ?>
								  <option value="<?php echo $key ?>" <?php if ($key == $duitku_va_mandirih2h_status) echo 'selected' ?> ><?php echo $value ?></option>
								<?php endforeach ?>
							  </select>
							</div>
						</div> 
						...
						<div class="form-group required">
							...
							<div class="col-sm-3">
							  <input type="text" name="duitku_va_mandirih2h_display_name" value="<?php echo $duitku_va_mandirih2h_display_name; ?>" id="input-merchant-id" class="form-control" />
							</div>
							<div class="col-sm-7">
						...
						<div class="form-group required">
							...
							<div class="col-sm-3">
							  <input type="text" name="duitku_va_mandirih2h_endpoint" value="<?php echo $duitku_va_mandirih2h_endpoint; ?>" id="input-merchant-id" class="form-control" />
							</div>
							<div class="col-sm-7">
						...
						<div class="form-group v2_settings sensitive required">
							...
							<div class="col-sm-3">
								<select name="duitku_va_mandirih2h_environment" id="input-mode" class="form-control">
									<?php $options = array('development' => 'Sandbox', 'production' => 'Production') ?>
									<?php foreach ($options as $key => $value): ?>
									<option value="<?php echo $key ?>" <?php if ($key == $duitku_va_mandirih2h_environment) echo 'selected' ?> ><?php echo $value ?></option>
									<?php endforeach ?>
								</select>
							</div>
							<div class="col-sm-7">
						...
						<div class="form-group required v2_settings sensitive">
							...
							<div class="col-sm-3">
							  <input type="text" name="duitku_va_mandirih2h_merchant" value="<?php echo $duitku_va_mandirih2h_merchant; ?>" id="input-merchant-id" class="form-control" />
							</div>
							<div class="col-sm-7">
						...
						<div class="form-group required v2_settings sensitive">
							...
							<div class="col-sm-3">
							  <input type="text" name="duitku_va_mandirih2h_api_key" value="<?php echo $duitku_va_mandirih2h_api_key; ?>" id="input-merchant-id" class="form-control" />
							</div>
							<div class="col-sm-7">
						...
						<div class="form-group required v2_settings sensitive">
							...
							<div class="col-sm-3">
							  <input type="number" name="duitku_va_mandirih2h_expired" value="<?php echo $duitku_va_mandirih2h_expired; ?>" id="input-merchant-id" class="form-control" />
							</div>
							<div class="col-sm-7">
					...
					<?php foreach (array('duitku_va_mandirih2h_success_mapping', 'duitku_va_mandirih2h_pending_mapping', 'duitku_va_mandirih2h_failure_mapping') as $status): ?>
						<div class="form-group required">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-merchant-id"><?php echo $entry_geo_zone; ?></label>
							<div class="col-sm-3">
								<select name="duitku_va_mandirih2h_geo_zone_id"  class="form-control">
								<option value="0"><?php echo $text_all_zones; ?></option>
								<?php foreach ($geo_zones as $geo_zone) { ?>
									<?php if ($geo_zone['geo_zone_id'] == $duitku_va_mandirih2h_geo_zone_id) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
							  <input size="1" type="text" name="duitku_va_mandirih2h_sort_order" value="<?php echo $duitku_va_mandirih2h_sort_order; ?>" class="form-control" />
							</div>
						</div>
						<div>
