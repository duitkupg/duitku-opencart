		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_cc_display_name" value="<?php echo $duitku_cc_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_cc_endpoint" value="<?php echo $duitku_cc_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_cc_merchant" value="<?php echo $duitku_cc_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_cc_api_key" value="<?php echo $duitku_cc_api_key; ?>" />
          ...
          <tr>
            ...
            <td>
              <select name="duitku_cc_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_cc_sort_order" value="<?php echo $duitku_cc_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
