  ...
  <div class="content">               
    ...
    <table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_qris_status">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_qris_display_name" value="<?php echo $duitku_qris_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_qris_endpoint" value="<?php echo $duitku_qris_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_qris_merchant" value="<?php echo $duitku_qris_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_qris_api_key" value="<?php echo $duitku_qris_api_key; ?>" />
        ...
        <td><input type="number" name="duitku_qris_expired" value="<?php echo $duitku_qris_expired; ?>" />
      ...
      <!-- expired_period Key -->
           ...
           <?php foreach (array('duitku_qris_success_mapping', 'duitku_qris_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_qris_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_qris_sort_order" value="<?php echo $duitku_qris_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
