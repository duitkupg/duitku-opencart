		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_varitel_status">
                <?php $options = array('1' => $text_enabled, '0' => $text_disabled) ?>
                <?php foreach ($options as $key => $value): ?>
                  <option value="<?php echo $key ?>" <?php if ($key == $duitku_varitel_status) echo 'selected' ?> ><?php echo $value ?></option>
                <?php endforeach ?>
              </select>
            </td>
          </tr>
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_varitel_display_name" value="<?php echo $duitku_varitel_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_varitel_endpoint" value="<?php echo $duitku_varitel_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_varitel_merchant" value="<?php echo $duitku_varitel_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_varitel_api_key" value="<?php echo $duitku_varitel_api_key; ?>" />
          ...
          <!-- API Key -->
			  ...
			  <tr>
				...
				<td><input type="number" name="duitku_varitel_expired" value="<?php echo $duitku_varitel_expired; ?>" />
           ...
           <?php foreach (array('duitku_varitel_success_mapping', 'duitku_varitel_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_varitel_geo_zone_id">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                  <?php if ($geo_zone['geo_zone_id'] == $duitku_varitel_geo_zone_id) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_varitel_sort_order" value="<?php echo $duitku_varitel_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
