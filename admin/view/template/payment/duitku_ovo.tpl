		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_ovo_display_name" value="<?php echo $duitku_ovo_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_ovo_endpoint" value="<?php echo $duitku_ovo_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_ovo_merchant" value="<?php echo $duitku_ovo_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_ovo_api_key" value="<?php echo $duitku_ovo_api_key; ?>" />
          ...
          <!-- API Key -->
           ...
           <?php foreach (array('duitku_ovo_success_mapping', 'duitku_ovo_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_ovo_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_ovo_sort_order" value="<?php echo $duitku_ovo_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
