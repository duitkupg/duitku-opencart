		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_nobu_qris_status">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_nobu_qris_display_name" value="<?php echo $duitku_nobu_qris_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_nobu_qris_endpoint" value="<?php echo $duitku_nobu_qris_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_nobu_qris_merchant" value="<?php echo $duitku_nobu_qris_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_nobu_qris_api_key" value="<?php echo $duitku_nobu_qris_api_key; ?>" />
          ...
          <!-- API Key -->
			  ...
			  <tr>
				...
				<td><input type="number" name="duitku_nobu_qris_expired" value="<?php echo $duitku_nobu_qris_expired; ?>" />
           ...
           <?php foreach (array('duitku_nobu_qris_success_mapping', 'duitku_nobu_qris_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_nobu_qris_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_nobu_qris_sort_order" value="<?php echo $duitku_nobu_qris_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
