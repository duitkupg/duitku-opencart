		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_briva_status">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_briva_display_name" value="<?php echo $duitku_briva_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_briva_endpoint" value="<?php echo $duitku_briva_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_briva_merchant" value="<?php echo $duitku_briva_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_briva_api_key" value="<?php echo $duitku_briva_api_key; ?>" />
          ...
          <!-- API Key -->
			  ...
			  <tr>
				...
				<td><input type="number" name="duitku_briva_expired" value="<?php echo $duitku_briva_expired; ?>" />
           ...
           <?php foreach (array('duitku_briva_success_mapping', 'duitku_briva_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_briva_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_briva_sort_order" value="<?php echo $duitku_briva_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
