		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_pospay_status">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_pospay_display_name" value="<?php echo $duitku_pospay_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_pospay_endpoint" value="<?php echo $duitku_pospay_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_pospay_merchant" value="<?php echo $duitku_pospay_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_pospay_api_key" value="<?php echo $duitku_pospay_api_key; ?>" />
          ...
          <!-- API Key -->
			  ...
			  <tr>
				...
				<td><input type="number" name="duitku_pospay_expired" value="<?php echo $duitku_pospay_expired; ?>" />
           ...
           <?php foreach (array('duitku_pospay_success_mapping', 'duitku_pospay_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_pospay_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_pospay_sort_order" value="<?php echo $duitku_pospay_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
