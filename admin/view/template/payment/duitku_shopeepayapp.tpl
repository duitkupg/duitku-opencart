		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
 		<table class="form">
          <tr>
            ...
            <td>
              <select name="duitku_shopeepayapp_status">
          ...
          <!-- Status -->
            ...
            <td><input type="text" name="duitku_shopeepayapp_display_name" value="<?php echo $duitku_shopeepayapp_display_name; ?>" />
          ...
          <!-- Display name -->
           ...
           <tr>
            ...
            <td>
             <input type="text" name="duitku_shopeepayapp_endpoint" value="<?php echo $duitku_shopeepayapp_endpoint; ?>" id="input-merchant-id" />
            ...
            <td>
             <input type="text" name="duitku_shopeepayapp_merchant" value="<?php echo $duitku_shopeepayapp_merchant; ?>" id="input-merchant-id" />
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_shopeepayapp_api_key" value="<?php echo $duitku_shopeepayapp_api_key; ?>" />
          ...
          <!-- API Key -->
			  ...
			  <tr>
				...
				<td><input type="number" name="duitku_shopeepayapp_expired" value="<?php echo $duitku_shopeepayapp_expired; ?>" />
           ...
           <?php foreach (array('duitku_shopeepayapp_success_mapping', 'duitku_shopeepayapp_failure_mapping') as $status): ?>
            <tr class="">
          ...
          <tr>
            ...
            <td>
              <select name="duitku_shopeepayapp_geo_zone_id">
          ...
          <tr>
            ...
            <td><input type="text" name="duitku_shopeepayapp_sort_order" value="<?php echo $duitku_shopeepayapp_sort_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
      <div>
