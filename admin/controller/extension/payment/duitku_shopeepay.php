...
class ControllerExtensionPaymentDuitkuShopeepay extends Controller {
  ...
  protected function validate() {
	...
	if (!$this->request->post['payment_duitku_shopeepay_expired'] OR $this->request->post['payment_duitku_shopeepay_expired'] > 60 OR $this->request->post['payment_duitku_shopeepay_expired'] < 0) {
