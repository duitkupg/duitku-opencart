...
class ControllerExtensionPaymentDuitkuBnc extends Controller {
  ...
  protected function validate() {
	...
	if (!$this->request->post['payment_duitku_bnc_expired'] OR $this->request->post['payment_duitku_bnc_expired'] > 1440 OR $this->request->post['payment_duitku_bnc_expired'] < 0 ) {
