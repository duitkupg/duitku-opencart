...
class ControllerExtensionPaymentDuitkuVACimb extends Controller {
  ...
  protected function validate() {
	...
	if (!$this->request->post['payment_duitku_va_cimb_expired'] OR $this->request->post['payment_duitku_va_cimb_expired'] > 1440 OR $this->request->post['payment_duitku_va_cimb_expired'] < 0) {
