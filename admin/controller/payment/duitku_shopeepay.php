...
class ControllerPaymentDuitkuShopeepay extends Controller {
  ...
  public function index() {
    ...
    $data['action'] = $this->url->link('payment/duitku_shopeepay', 'token=' . $this->session->data['token'], 'SSL');
  ...
  $this->response->setOutput($this->load->view('payment/duitku_shopeepay.tpl',$data));
