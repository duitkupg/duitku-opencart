...
class ControllerPaymentDuitkuBriva extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_briva/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_briva');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_briva');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_briva/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_briva/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '01') {
      ...
      $redirUrl = $this->url->link('payment/duitku_briva/failure');
      $this->response->redirect($redirUrl);
