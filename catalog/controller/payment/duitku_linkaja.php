...
class ControllerPaymentDuitkuLinkaja extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_linkaja/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_linkaja');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_linkaja');
    ...
    $expired = $this->config->get('duitku_linkaja_expired') != null ? $this->config->get('duitku_linkaja_expired') : 1440;
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_linkaja/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_linkaja/payment_notification'),
