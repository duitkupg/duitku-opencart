...
class ControllerPaymentDuitkuAtome extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_atome/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_atome');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_atome');
    ...
    $expired = $this->config->get('duitku_atome_expired') != null ? $this->config->get('duitku_atome_expired') : 1440;
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_atome/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_atome/payment_notification'),
