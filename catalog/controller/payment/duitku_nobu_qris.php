...
class ControllerPaymentDuitkuNobuQris extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_nobu_qris/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_nobu_qris');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_nobu_qris/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_nobu_qris/payment_notification'),
