...
class ControllerPaymentDuitkuShopeepayapp extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_shopeepayapp/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_shopeepayapp');
    ...
    $expired = $this->config->get('duitku_shopeepayapp_expired') != null ? $this->config->get('duitku_shopeepayapp_expired') : 1440;
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_shopeepayapp/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_shopeepayapp/payment_notification'),
