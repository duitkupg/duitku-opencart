...
class ControllerPaymentDuitkuIndomaret extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_indomaret/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_indomaret');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_indomaret');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_indomaret/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_indomaret/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '01') {
      ...
      $redirUrl = $this->url->link('payment/duitku_indomaret/failure');
      $this->response->redirect($redirUrl);
