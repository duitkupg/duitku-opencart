...
class ControllerPaymentDuitkuQris extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_qris/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_qris');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_qris');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_qris/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_qris/payment_notification'),
