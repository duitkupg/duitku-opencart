...
class ControllerPaymentDuitkuVARitel extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_va_ritel/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_va_ritel');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_va_ritel/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_va_ritel/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '01') {
      ...
      $redirUrl = $this->url->link('payment/duitku_va_ritel/failure');
      $this->response->redirect($redirUrl);
