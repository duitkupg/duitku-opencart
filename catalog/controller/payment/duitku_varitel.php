...
class ControllerPaymentDuitkuVaritel extends Controller {
  ...
  public function process_order() {    
	...
	$expired = $this->config->get('duitku_varitel_expired') != null ? $this->config->get('duitku_varitel_expired') : 1440;
   ...
   /* Duitku_Config::$isProduction =
    ...
    try {     
      $redirUrl = DuitkuCore_Web::getRedirectionUrl($this->config->get('duitku_varitel_endpoint'), $params);       
   ...
   * http://[your shop’s homepage]/index.php?route=payment/duitku_varitel/payment_notification
   */
