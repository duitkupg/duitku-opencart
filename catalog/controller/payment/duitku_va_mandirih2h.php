...
class ControllerPaymentDuitkuVAMandirih2h extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_va_mandirih2h/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_va_mandirih2h');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_va_mandirih2h/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_va_mandirih2h/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '01') {
      ...
      $redirUrl = $this->url->link('payment/duitku_va_mandirh2h/failure');
      $this->response->redirect($redirUrl);
