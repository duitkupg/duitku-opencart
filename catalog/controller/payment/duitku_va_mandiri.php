...
class ControllerPaymentDuitkuVAMandiri extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_va_mandiri/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_va_mandiri');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_va_mandiri/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_va_mandiri/payment_notification'),
