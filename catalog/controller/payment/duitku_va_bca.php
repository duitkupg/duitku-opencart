...
class ControllerPaymentDuitkuVABca extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_va_bca/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_va_bca');
    $this->load->model('checkout/order');
    $this->load->model('total/shipping');
    $this->load->language('payment/duitku_va_bca');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_va_bca/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_va_bca/payment_notification'),
