...
class ControllerPaymentDuitkuVAAtmbersama extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'payment/duitku_va_atmbersama/process_order';
  ...
  public function process_order() {    
    $this->load->model('payment/duitku_va_atmbersama');
    ...
    $params = array(
          ...
          'returnUrl' => $this->url->link('payment/duitku_va_atmbersama/landing_redir'),
          'callbackUrl' => $this->url->link('payment/duitku_va_atmbersama/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '01') {
      ...
      $redirUrl = $this->url->link('payment/duitku_va_atmbersama/failure');
      $this->response->redirect($redirUrl);
