...
class ControllerExtensionPaymentDuitkuAtome extends Controller {
  ...
  public function process_order() {    
    ...
    //generate Signature
    $merchant_code = $this->config->get('payment_duitku_atome_merchant');
    $api_key = $this->config->get('payment_duitku_atome_api_key');
    ...
    try {  
      ...
      $result = DuitkuCore_Web::getRedirectionUrl($this->config->get('payment_duitku_atome_endpoint'), $params);
  ...
  */
  ...
  public function payment_notification() {
    ...
    $api_key = $this->config->get('payment_duitku_atome_api_key');
    $merchant_code = $this->config->get('payment_duitku_atome_merchant');    
    $endpoint = $this->config->get('payment_duitku_atome_endpoint');
    ...
    if ($current_status_id == $this->config->get('payment_duitku_atome_success_mapping')){
      header("HTTP/1.1 200");
