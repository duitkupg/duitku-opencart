...
class ControllerExtensionPaymentDuitkuVABni extends Controller {
  ...
  public function process_order() {    
	...
	$expired = $this->config->get('duitku_va_bni_expired') != null ? $this->config->get('duitku_va_bni_expired') : 1440;
    ...
    try {
      ...
      $redirUrl = DuitkuCore_Web::getRedirectionUrl($this->config->get('duitku_va_bni_endpoint'), $params);
