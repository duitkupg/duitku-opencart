...
class ControllerExtensionPaymentDuitkuMG extends Controller {
  ...
  public function index() {
    ...
    $data['process_order'] = 'extension/payment/duitku_mg/process_order';
  ...
  public function process_order() {    
    $this->load->model('extension/payment/duitku_mg');
    ...
    $cred_code = $this->config->get('duitku_mg_credcode');
    ...
    $params = array(
          ...
          'signature' => $signature,
		      'expiryPeriod' => 1440,       
          'returnUrl' => $this->url->link('extension/payment/duitku_mg/landing_redir'),
          'callbackUrl' => $this->url->link('extension/payment/duitku_mg/payment_notification'),
  ...
  public function landing_redir() {    
    ...
    if (isset($_GET['resultCode']) && isset($_GET['merchantOrderId']) && isset($_GET['reference']) && $_GET['resultCode'] == '00') {
      ...
      // $redirUrl = $this->url->link('checkout/cart');
      $redirUrl = $this->url->link('extension/payment/duitku_mg/failure');
      $this->response->redirect($redirUrl);
