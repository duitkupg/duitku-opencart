...
class ControllerExtensionPaymentDuitkuIndodana extends Controller {
  ...
  public function process_order() {    
    ...
    try {  
      ...
      $result = DuitkuCore_Web::getRedirectionUrl($this->config->get('payment_duitku_indodana_endpoint'), $params);
  ...
  */
  ...
  public function payment_notification() {
    ...
    if ($current_status_id == $this->config->get('payment_duitku_indodana_success_mapping')){
      header("HTTP/1.1 200");
