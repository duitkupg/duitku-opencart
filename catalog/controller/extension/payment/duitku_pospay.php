...
class ControllerExtensionPaymentDuitkuPosPay extends Controller {
  ...
  public function process_order() {    
    ...
    //generate Signature
    $merchant_code = $this->config->get('payment_duitku_pospay_merchant');
    $api_key = $this->config->get('payment_duitku_pospay_api_key');
	$expired = $this->config->get('payment_duitku_pospay_expired') != null ? $this->config->get('payment_duitku_pospay_expired') : 1440;
    ...
    try {  
      ...
      $redirUrl = DuitkuCore_Web::getRedirectionUrl($this->config->get('payment_duitku_pospay_endpoint'), $params,  $this->log);
  ...
  */
  ...
  public function payment_notification() {
    ...
    $api_key = $this->config->get('payment_duitku_pospay_api_key');
    $merchant_code = $this->config->get('payment_duitku_pospay_merchant');    
    $endpoint = $this->config->get('payment_duitku_pospay_endpoint');
