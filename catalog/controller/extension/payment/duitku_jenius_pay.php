...
class ControllerExtensionPaymentDuitkuJeniusPay extends Controller {
  ...
  public function process_order() {    
    ...
    //generate Signature
    $merchant_code = $this->config->get('payment_duitku_jenius_pay_merchant');
    $api_key = $this->config->get('payment_duitku_jenius_pay_api_key');
	$expired = $this->config->get('payment_duitku_jenius_pay_expired') != null ? $this->config->get('payment_duitku_jenius_pay_expired') : 60;
    ...
    try {  
      ...
      $result = DuitkuCore_Web::getRedirectionUrl($this->config->get('payment_duitku_jenius_pay_endpoint'), $params);
  ...
  */
  ...
  public function payment_notification() {
    ...
    $api_key = $this->config->get('payment_duitku_jenius_pay_api_key');
    $merchant_code = $this->config->get('payment_duitku_jenius_pay_merchant');    
    $endpoint = $this->config->get('payment_duitku_jenius_pay_endpoint');
    ...
    if ($current_status_id == $this->config->get('payment_duitku_jenius_pay_success_mapping')){
      header("HTTP/1.1 200");
