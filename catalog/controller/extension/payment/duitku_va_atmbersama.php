...
class ControllerExtensionPaymentDuitkuVAAtmbersama extends Controller {
  ...
  public function process_order() {    
    ...
    try {   
      ...
      $redirUrl = Duitku_CoreWeb::getRedirectionUrl($this->config->get('payment_duitku_va_atmbersama_endpoint'), $params);
  ...
  */
  ...
  public function payment_notification() {
    ...
    if ($order_info) {
        ...
        if ($status == '00' && Duitku_CoreWeb::validateTransaction($endpoint, $merchant_code, $order_id, $reference, $api_key)) {
